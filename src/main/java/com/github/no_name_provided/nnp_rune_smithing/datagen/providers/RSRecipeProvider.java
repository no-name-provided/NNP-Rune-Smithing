...
public class RSRecipeProvider extends net.minecraft.data.recipes.RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput output, HolderLookup.Provider holderLookup) {
        ...
        new AlloyRecipeBuilder(
                new FluidStack(unsafeGetFluidFromRegistryPath("molten_solder"), 5),
                SizedFluidIngredient.of(new FluidStack(unsafeGetFluidFromRegistryPath("molten_tin"), 1)),
                SizedFluidIngredient.of(new FluidStack(unsafeGetFluidFromRegistryPath("molten_silver"), 4))
        ).unlockedBy("has_alloyer", has(RSBlocks.ALLOYER.get()))
                .save(output, ResourceLocation.fromNamespaceAndPath(MODID, "alloy/default_solder"));
        new AlloyRecipeBuilder(
                new FluidStack(unsafeGetFluidFromRegistryPath("molten_bronze"), 8),
                // We hard code ids here because we have saved no direct reference to our autogenerated fluids
                SizedFluidIngredient.of(new FluidStack(unsafeGetFluidFromRegistryPath("molten_copper"), 7)),
                SizedFluidIngredient.of(new FluidStack(unsafeGetFluidFromRegistryPath("molten_tin"), 1))
        ).unlockedBy("has_alloyer", has(RSBlocks.ALLOYER.get()))
                .save(output, ResourceLocation.fromNamespaceAndPath(MODID, "alloy/default_bronze"));
        new AlloyRecipeBuilder(
                new FluidStack(unsafeGetFluidFromRegistryPath("molten_electrum"), 2),
                SizedFluidIngredient.of(new FluidStack(unsafeGetFluidFromRegistryPath("molten_gold"), 1)),
                SizedFluidIngredient.of(new FluidStack(unsafeGetFluidFromRegistryPath("molten_silver"), 1))
        ).unlockedBy("has_alloyer", has(RSBlocks.ALLOYER.get()))
