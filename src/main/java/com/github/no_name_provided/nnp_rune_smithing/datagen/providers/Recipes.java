...
public class Recipes extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput output, HolderLookup.Provider holderLookup) {
        ...
        new AlloyRecipeBuilder(
                ...
                SizedFluidIngredient.of(new FluidStack(getFluidFromRegistryPath("molten_bismuth"), 1)),
                SizedFluidIngredient.of(new FluidStack(getFluidFromRegistryPath("molten_titanium"), 1))
        ).unlockedBy("has_alloyer", has(RSBlocks.ALLOYER.get()))
