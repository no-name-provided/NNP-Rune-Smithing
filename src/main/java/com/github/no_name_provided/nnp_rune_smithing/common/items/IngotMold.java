...
public class IngotMold extends Item implements CastingMold {
    ...
    public ItemStack getResult(FluidStack fluid) {
        if (recipeBuffer.containsKey(fluid.getFluid())) {
            ...
            LogUtils.getLogger().warn("Failed to process casting recipe. Make sure there's an ingot with the correct tag, the fluid set exists, and everything is registered!");
