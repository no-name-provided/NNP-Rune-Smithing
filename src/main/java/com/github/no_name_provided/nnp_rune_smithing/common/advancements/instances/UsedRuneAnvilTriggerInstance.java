...
/**
 * Represents an instance of the UsedRuneAnvilTrigger.
 *
 * @param player The player that inlaid the rune.
 * @param base The item the "rune" was inlaid into.
 * @param addition The "rune" that was inlaid.
 */
public record UsedRuneAnvilTriggerInstance(Optional<ContextAwarePredicate> player, Optional<ItemPredicate> base,
    ...
    /**
     * Convenience method that can be used to easily define an advancement granted by this trigger.
     *
     * @param player The player that inlaid the rune.
     * @param base The item the "rune" was inlaid into.
     * @param addition The "rune" that was inlaid.
     * @return A trigger instance which can be used to define an advancement.
     */
    ...
    /**
     * Predicate that determines whether an instance of the advancement should be granted.
     *
     * @param base The item the "rune" was inlaid into.
     * @param addition The "rune" that was inlaid.
     */
